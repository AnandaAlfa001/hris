            ...
            {{ csrf_field() }}
              <div class="box-body">
                <div class="form-group">
                 ...
                 <div class="form-group">
                  <label>Nama</label>
                  <input type="text" class="form-control" name="Nama" value="{{ $tampilhistory->nama_karyawan }}" placeholder="Nama" readonly>
                </div>
                ...
                <div id="go">
                  ...
                  <div class="col-xs-2">
                     <div class="form-group">
                        <input type="text" class="form-control" name="golonganoutbaru" value="{{ $tampilhistory->nama_golonganout }}" id="golonganoutlain" placeholder="Golongan Out Lainnya" >
                      </div> 
                  </div><br>
                </div>
                <br>
