        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Edit Lembur</h3>
            </div>

        <form role="form" method="POST" action="{{url('saveeditlembur', $data->ID)}}">
          {{ csrf_field() }}
            <div class="box-body">
              <div id="alertz">
                @if (count($errors)>0)
              ...
              <div class="input-group col-md-12">
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" class="form-control" name="PemberiLembur" value="{{$data->NIKPemberiLembur}}">
                        <input type="text" class="form-control" placeholder="Pemberi Lembur" value="{{$pemberi->Nama}}" readonly >
                    </div>
                    <label>Tgl. Mulai Lembur</label>
                    <div class="form-group">
                        <input type="date" class="form-control" name="tglmulai" placeholder="YYYY-MMM-DDD" value="{{$data->TanggalMulaiLembur}}" > 
                    </div>
                    <label>Tgl. Selesai Lembur</label>
                    <div class="form-group">    
                        <input type="date"  class="form-control" name="tglselesai" placeholder="YYYY-MMM-DDD" value="{{$data->TanggalSelesaiLembur}}" required> 
                    </div>
                    ...
                    <div class="bootstrap-timepicker">
                      <div class="form-group">
                        ...
                        <div class="input-group">
                          <input type="text" class="form-control timepicker" name="JamMulaiBaru" required>
                    ...
                    <div class="bootstrap-timepicker">
                      <div class="form-group">
                        ...
                        <div class="input-group">
                          <input type="text" class="form-control timepicker" name="PerkiraanJamSelesaiBaru" required>
                    ...
                    <div class="form-group">
                        <textarea class="form-control" name="Kegiatan" readonly required>{{$data->Kegiatan}}</textarea>
                    </div>
                    <br><br><br><br>
                    <div class="box-footer">
                      <button type="submit" class="btn btn-primary">Ajukan Ubah Lembur</button>
                    </div>
