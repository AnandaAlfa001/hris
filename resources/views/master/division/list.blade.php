...
<div class="content-wrapper">
  ...
  <section class="content">
    <div class="text-right">
      <a href="{{ url('master/division/new') }}" class="btn btn-success"><i class="fa fa-plus"></i>&emsp;Tambah</a>
    </div>
    <div class="row">
      <div class="col-xs-12">
...
<script type="module">
  ...
  let urlData = '<?= url('master/division/data') ?>';
            ...
            h('a', {
                ...
                onClick: () => {
                  if (confirm('Apakah Anda yakin ?')) {
                    return window.open(`{{ url('master/division') }}/${cell}/delete`, '_self')
                  }
                }
              },
              h('i', {
  ...
  }).render(document.getElementById("divisionList"));
</script>
@endsection