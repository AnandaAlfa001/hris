...
$notif1     = EmployeeModel::select(
                'tb_cuti.ID as idcuti', 'tb_datapribadi.Nama as nama', 'tb_cuti.Keterangan as keterangan', 'tb_datapribadi.photo', 'tb_cuti.TanggalMulaiCuti as tgl_mulai')
              ->leftjoin('tb_cuti', 'tb_datapribadi.NIK', '=', 'tb_cuti.NIK')
              ->whereRaw(
                DB::raw('CASE WHEN tb_cuti.approve_1 = "N" and tb_cuti.approve_2 IS NULL THEN tb_datapribadi.atasan1 = "' . $nikatasan . '" WHEN tb_cuti.approve_2 = "N" and tb_cuti.approve_1 = "Y" THEN tb_datapribadi.atasan2 = "' . $nikatasan . '" END')
              )->get();
...
$daftarlemburan = LemburModel::select(
  'tb_lembur.ID',
  'tb_datapribadi.photo',
  'tb_datapribadi.Nama as nama',
  'tb_lembur.TanggalMulaiLembur',
  'tb_lembur.TanggalSelesaiLembur',
  'tb_lembur.Kegiatan',
  'tb_lembur.status as status',
  DB::raw('CASE 
