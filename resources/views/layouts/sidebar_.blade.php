      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="{{ url('subdivisilist') }}"><i class="fa fa-circle-o"></i> Master Sub-Divisi</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
             @if(Session::get('admin') == 1 or Session::get('admin') == 2)
            <li><a href="{{ url('reportemployee') }}"><i class="fa fa-circle-o"></i> Report Data Karyawan</a></li>
            <li><a href="{{ url('reportcuti') }}"><i class="fa fa-circle-o"></i> Report Data Cuti</a></li>
            <li><a href="{{ url('reportkesehatan') }}"><i class="fa fa-circle-o"></i> Report Data Kesahatan</a></li>
            <li><a href="{{ url('reporttraining') }}"><i class="fa fa-circle-o"></i> Report Data Training</a></li>
            <li><a href="{{ url('reportlembur') }}"><i class="fa fa-circle-o"></i> Report Lembur Karyawan</a></li>
            @endif
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="{{ url('daftarpeg') }}"><i class="fa fa-circle-o"></i>Daftar Absen Pegawai</a></li> 
            @endif          
          </ul>
        </li>
