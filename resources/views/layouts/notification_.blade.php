...
use App\AbsenRekapModel;
                ...
                $daftarlemburan = LemburModel::select('tb_lembur.ID','tb_datapribadi.photo','tb_datapribadi.Nama as nama','tb_lembur.TanggalMulaiLembur','tb_lembur.TanggalSelesaiLembur','tb_lembur.Kegiatan','tb_lembur.status as status',
                  ...
                  $daftarabsen = AbsenRekapModel::select('tb_datapribadi.nik','tb_datapribadi.nama','tb_datapribadi.photo',DB::raw('MONTH(absen_rekap.tgl) AS bulan'),DB::raw('YEAR(absen_rekap.tgl) AS tahun'),'absen_rekap.id as id_absen')
