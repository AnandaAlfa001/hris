...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Tambah Data Klaim Kesehatan
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Kesehatan</a></li>
        <li class="active">Add Klaim</li>
      </ol>
    </section>
