...
<div class="controls">
<form role="form" method="POST" enctype="multipart/form-data" action="{{ url('/saverawatgigi') }}">
  {{ csrf_field() }}
    <div class="box-body">
      <div id="alertz3">
        @if (count($errors)>0)
      ...
      <div class="input-group col-md-12">
          <div class="col-md-6">
            ...
            <div class="input-group input-group-sm">
              <select class="form-control select2" id="pasien2" name="pasien" style="width:100%;">
            ...
            <div class="form-group">
                ...
                <input type="hidden" class="form-control" id="jsetuju_2" name="jsetuju" placeholder="Jumlah Disetujui" required>
                <input type="text" class="form-control" id="jsetuju2" placeholder="Jumlah Disetujui" required>
            </div>
            <br><br>
