...
<div class="controls">
<form role="form" method="POST" enctype="multipart/form-data" action="{{ url('/savereqrj') }}">
  {{ csrf_field() }}
    <div class="box-body">
      <div id="alertz">
        @if (count($errors)>0)
      ...
      <div class="input-group col-md-12">
          <div class="col-md-6">
            ...
            <div class="form-group">
              <select class="form-control select2" id="pasien" onchange="getjalan()" name="pasien" style="width:100%;">
