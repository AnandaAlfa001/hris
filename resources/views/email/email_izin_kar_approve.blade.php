                ...
                width="560">
                    ...
                    <tr>
                        <td align="center" class="hero" style="background-color: #3c8dbc;border-collapse: collapse; border-spacing: 0; margin: 0; padding: 10px 0;" valign="top">
                            ...
                            <h2 style="color:#fff;font-family:Helvetica;">Request Izin - Izin Telah Disetujui</h2>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <b>Berikut detail izin Anda yang telah disetujui:</b><br>
                        Nama : {{$nama_karyawan}} <br>
                        Alasan : {{$status}} <br>
                        Tanggal : {{$tanggal}} <br>
                        Jam : {{$jam_mulai}} - {{$jam_selesai}} <br>
                        Keterangan : {{$keterangan}} <br>
                        Approved By : {{$approvedbys}}
                        </p>
                        </td>
                    </tr><!-- BUTTON -->
