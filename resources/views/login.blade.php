  ...
  <div class="login-box-body">
    ...
    {{ csrf_field() }}
      <div class="form-group has-feedback">
        <input type="text" name="email" class="form-control" placeholder="Email tanpa @ edi-indonesia.co.id" @if(session('mail'))value="{{ session('mail') }}" @endif required>
