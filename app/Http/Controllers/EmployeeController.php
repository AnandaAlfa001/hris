...
class EmployeeController extends Controller
{
    ...
    public function HOME() {
      ...
      $tablehistory = HistoryJabModel::select('tb_his_jabatan.id','tgl_sk_jab','tgl_sk_gol','tb_lokasikerja.lokasi as lokasi','tbldivmaster.nama_div_ext as divisi','TglKontrak','TglKontrakEnd','tb_his_jabatan.gaji',
      ...
      $historykes = KesehatanModel::select('tb_kesehatan.ID as idkes','tglklaim','remb','kwitansi','nama_apotek','tglberobat','diagnosa','total_klaim','approve',
              DB::raw('CASE
    ...
    public function INDEX() {
         ...
         $CallEmp = KaryawanModel::select('sqc_nik','NIK','Nama','Alamat','NoHp','email','statuskar',
    ...
    public function KARTTPLIST(){
        $CallEmp = KaryawanModel::select('sqc_nik','NIK','Nama','Alamat','NoHp','email',
                                    DB::raw('CONCAT(SUBSTR(NIK,1,LENGTH(NIK) - 3),"-", RIGHT(NIK,3)) as nikFormat'),
                                    DB::raw('CONCAT(tbldivmaster.nama_div_ext, IF(ISNULL(tb_subdivisi.subdivisi),"",CONCAT(" - ",tb_subdivisi.subdivisi))) as Divisi'),
                                    DB::raw('CONCAT(tb_pangkat.pangkat, " - " , tb_jabatan.jabatan) as Jabatan'),
    ...
    return view('employee/resultsearch',compact('Result','atasan1','atasan2','statuskar','lokasikerja'));
     ...
     public function OUTEMPLOYEE() {
         $CallEmp = KaryawanModel::select('sqc_nik','NIK','Nama','Alamat','NoHp','email','alasan_out','tgl_out',
                                    DB::raw('CONCAT(SUBSTR(NIK,1,LENGTH(NIK) - 3),"-", RIGHT(NIK,3)) as nikFormat'),
                                    DB::raw('CONCAT(tbldivmaster.nama_div_ext, IF(ISNULL(tb_subdivisi.subdivisi),"",CONCAT(" - ",tb_subdivisi.subdivisi))) as Divisi'),
                                    DB::raw('CONCAT(tb_pangkat.pangkat, " - " , tb_jabatan.jabatan) as Jabatan'),
                                    DB::raw('CASE WHEN statuskar = "5" THEN (SELECT gol FROM tb_golongan_outsource WHERE id = tb_datapribadi.golongan) ELSE (SELECT gol FROM tb_golongan WHERE id = tb_datapribadi.golongan) END as Gol')
    ...
    public function FUNC_DETAILEMPLOYEE($nik) {
        ...
        $data = KaryawanModel::select('tb_datapribadi.*','tb_agama.nama_agama as namaagamakar','dokumen_ktp.File as file_ktp',
                  'dokumen_npwp.File as file_npwp', 'dokumen_no_rek.File as file_no_rek','dokumen_jamsostek.File as file_jamsostek',
        ...
        $historyjab = HistoryJabModel::select('tb_his_jabatan.tgl_sk_jab','tb_his_jabatan.tgl_sk_gol','tb_lokasikerja.lokasi as lokasi','tbldivmaster.nama_div_ext as divisi','tb_statuskar.status_kar as statuskar','tb_his_jabatan.no_sk as no_sk',
          'tb_his_jabatan.gaji','tb_his_jabatan.tunj_jab', 'tb_his_jabatan.tunj_tmr',
                                    DB::raw('CONCAT(tb_pangkat.pangkat, " - " , tb_jabatan.jabatan) as Jabatan'),
        ...
        $spdet = SPModel::select('tb_sp.id','tb_sp.tgl_sk','tb_sp.type_sp','tb_sp.keterangan','tb_sp.photo',
        ...
        $lemburdet = LemburModel::select('ID','TanggalMulaiLembur','TanggalSelesaiLembur','JamMulai','PerkiraanJamSelesai','Kegiatan','JamSelesaiAktual'
        ...
        $kesehatandet = KesehatanModel::select('tb_kesehatan.ID as idkes','tglklaim','remb','kwitansi','nama_apotek','tglberobat','diagnosa','total_klaim','total_apprv','approve',
              DB::raw('CASE
        ...
        $izindet = AbsenIjinModel::select('absen_izin.nama','absen_izin.nik','absen_izin.tanggal','absen_izin.stat','absen_izin.ket','absen_izin.alasan_reject','absen_izin.statusApp','absen_izin.jam_mulai','absen_izin.jam_selesai',
                 DB::raw('CASE
        ...
        $pddet = PerjalananDinasModel::select('tb_perjalanandinas.id','tb_perjalanandinas.nik','tb_perjalanandinas.jam_awal','tb_perjalanandinas.jam_akhir',
                    ...
                    DB::raw('(Select Nama From tb_datapribadi where tb_datapribadi.NIK = tb_perjalanandinas.nik OR tb_datapribadi.old_nik = tb_perjalanandinas.nik) as nama_kar'),'tb_perjalanandinas.keterangan'
                    )
    ...
    public function FUNC_PROFILEMPLOYEE($nik) {
        ...
        $historyjab = HistoryJabModel::select('tb_his_jabatan.tgl_sk_jab','tb_his_jabatan.tgl_sk_gol','tb_lokasikerja.lokasi as lokasi','tbldivmaster.nama_div_ext as divisi','tb_statuskar.status_kar as statuskar',
                                    DB::raw('CONCAT(tb_pangkat.pangkat, " - " , tb_jabatan.jabatan) as Jabatan'),
    ...
    public function FUNC_CETAKSK_PHK($nik){
      ...
      $data = EmployeeModel::select('tb_datapribadi.NIK as nik', 'tb_datapribadi.Nama', 'tb_datapribadi.dir_1_resign as nik_dir_utama',
                                        'tb_datapribadi.dir_1_resign as nik_dir_keuangan', 'tb_datapribadi.alasan_out',
    ...
    //$url_prev = explode('/',$_SERVER['HTTP_REFERER']);
		//$urlmen = end($url_prev);
         ...
         $historyjab = HistoryJabModel::select('tb_his_jabatan.tgl_sk_jab','tb_his_jabatan.tgl_sk_gol','tb_lokasikerja.lokasi as lokasi','tbldivmaster.nama_div_ext as divisi','tb_his_jabatan.gaji as gaji','tb_his_jabatan.no_sk as no_sk',
                                    DB::raw('CONCAT(tb_pangkat.pangkat, " - " , tb_jabatan.jabatan) as Jabatan'),
                                    DB::raw('CASE WHEN tb_his_jabatan.statuskar = "5" THEN (SELECT gol FROM tb_golongan_outsource WHERE id = tb_his_jabatan.golongan) ELSE (SELECT gol FROM tb_golongan WHERE id = tb_his_jabatan.golongan) END as Gol')
                                )
                            ->leftjoin('tbldivmaster','tb_his_jabatan.Divisi','=','tbldivmaster.id')
    ...
    public function FUNC_MUTASI($NIK) {
        ...
        $mutasiquery = HistoryJabModel::select('tb_his_jabatan.id','tb_his_jabatan.nik','tb_datapribadi.Nama as nama',
                                             'tb_his_jabatan.tgl_sk_jab as tanggal1','tb_his_jabatan.tgl_sk_gol as tanggal2',
                                             ...
                                             'tb_his_jabatan.TglKontrak as tgl_kontrak','tb_his_jabatan.TglKontrakEnd as tgl_akhir_kontrak',
                                             'tb_his_jabatan.divisi as divisi','tb_his_jabatan.lokasiker as lokasi','tb_his_jabatan.statuskar as statuskar','tb_his_jabatan.idpangkat as pangkat','tb_his_jabatan.idjabatan as jabatanid'
                                    // DB::raw('CONCAT(tb_pangkat.pangkat,"-",tb_jabatan.jabatan) as jabatan')
        ...
        $tablehistory = HistoryJabModel::select('tb_his_jabatan.id','tgl_sk_jab','tb_his_jabatan.no_sk','tgl_sk_gol','tb_lokasikerja.lokasi as lokasi','tbldivmaster.nama_div_ext as divisi','TglKontrak','TglKontrakEnd','tb_his_jabatan.gaji',
                                             'tb_his_jabatan.nik as nik','tb_his_jabatan.id_mutasi','tb_his_jabatan.no_sk',
                                    DB::raw('CONCAT(tb_pangkat.pangkat,"-",tb_jabatan.jabatan) as jabatan'),
                                    DB::raw('CASE WHEN statuskar = "5" THEN (SELECT gol FROM tb_golongan_outsource WHERE id = tb_his_jabatan.golongan) ELSE (SELECT gol FROM tb_golongan WHERE id = tb_his_jabatan.golongan) END as Gol')
                                    )
                                    ->leftjoin('tbldivmaster','tb_his_jabatan.divisi','=','tbldivmaster.id')
    ...
    public function FUNC_HISTORYJABATAN($NIK) {
        ...
        $historyquery = HistoryJabModel::select('tb_his_jabatan.id','tb_his_jabatan.nik','tb_datapribadi.Nama as nama'
                                    )
                                    ->leftjoin('tb_datapribadi','tb_his_jabatan.nik','=','tb_datapribadi.NIK')
                                    ->whereRaw(DB::raw('tb_his_jabatan.nik = "'.$NIK.'" or tb_his_jabatan.nik = (select old_nik from tb_datapribadi where NIK = "'.$NIK.'")'))
                                    ->orderBy('tb_his_jabatan.id','DESC')
        ...
        $tablehistory = HistoryJabModel::select('tb_his_jabatan.id','tb_his_jabatan.no_sk','tgl_sk_jab','tgl_sk_gol','tb_lokasikerja.lokasi as lokasi','tbldivmaster.nama_div_ext as divisi','TglKontrak','TglKontrakEnd','old_nik as nik_lama','tb_his_jabatan.gaji as gaji',
    ...
    public function FUNC_PERPANJANGKONTRAK($NIK) {
        $resigndata = HistoryJabModel::select('tb_his_jabatan.id','tb_his_jabatan.nik','tb_datapribadi.Nama as nama'
                                    )
                                    ...
                                    ->orderBy('id','DESC')
                                    ->first();
        $tablekontrak = KontrakModel::select('tb_kontrak.nik','tb_kontrak.id','tb_kontrak.tgl_kontrak','tb_kontrak.akhir_kontrak','tb_kontrak.level','tb_kontrak.gaji','tb_golongan_outsource.gol as golongan_out'
                                    )
    ...
    public function FUNC_EDITHISTORY($id) {
        ...
        // dd($NIK);
        $tampilhistory = HistoryJabModel::select('tb_his_jabatan.id','tb_his_jabatan.nik','tb_datapribadi.Nama as nama','tb_his_jabatan.old_nik as nik_lama','tb_his_jabatan.gaji as gaji','tb_his_jabatan.tunj_jab as tunj_jab','tb_his_jabatan.tunj_tmr as tunj_tmr',
                                             'tb_his_jabatan.tgl_sk_jab as tanggal1','tb_his_jabatan.tgl_sk_gol as tanggal2',
                                             'tb_his_jabatan.subdivisi as subdivisi', 'tb_his_jabatan.golongan as golonganid', 'tb_his_jabatan.golongan_out as golonganoutid',
                                             'tb_golongan.gol as nama_golongan','tb_golongan_outsource.gol as nama_golonganout','tb_pangkat.pangkat as nama_pangkat','tb_jabatan.jabatan as nama_jabatan','tbldivmaster.nama_div_ext as nama_divisi','tb_subdivisi.subdivisi as nama_subdivisi',
                                             'tb_pangkat.type as typepangkat','tb_jabatan.type as typejabatan','tb_golongan.type as typegolongan','tb_golongan_outsource.type as typegolonganout','tbldivmaster.type as typedivisi','tb_subdivisi.type as typesubdivisi',
                                             'tb_his_jabatan.atasan1 as atasan1',
                                             'tb_his_jabatan.atasan2 as atasan2',
    ...
    public function FUNC_EDITHISTORYTER($id) {
        ...
        // dd($NIK);
        $tampilhistory = HistoryJabModel::select('tb_his_jabatan.id','tb_his_jabatan.nik','tb_datapribadi.Nama as nama','tb_his_jabatan.old_nik as nik_lama',
                                             'tb_his_jabatan.tgl_sk_jab as tanggal1','tb_his_jabatan.tgl_sk_gol as tanggal2',
                                             'tb_his_jabatan.subdivisi as subdivisi', 'tb_his_jabatan.golongan as golonganid', 'tb_his_jabatan.golongan_out as golonganoutid',
                                             'tb_golongan.gol as nama_golongan','tb_golongan_outsource.gol as nama_golonganout','tb_pangkat.pangkat as nama_pangkat','tb_jabatan.jabatan as nama_jabatan','tbldivmaster.nama_div_ext as nama_divisi','tb_subdivisi.subdivisi as nama_subdivisi',
                                             'tb_pangkat.type as typepangkat','tb_jabatan.type as typejabatan','tb_golongan.type as typegolongan','tb_golongan_outsource.type as typegolonganout','tbldivmaster.type as typedivisi','tb_subdivisi.type as typesubdivisi',
    ...
    public function FUNC_CEKLASTSP(Request $request) {
        ...
        return response()->json(['nik_kar' => $nik_kar,
    ...
    public function FUNC_DAFTARSP(){
      ...
      $nik = Session::get('nik');
      if (Session::get('admin') == 1) {
        $daftarsp = SPModel::select('tb_sp.id','tb_sp.photo as photosp','tb_sp.nik','tb_sp.nik_pemberi_sp','tb_mst_sp.jenis_sp','tb_sp.keterangan','tb_sp.tgl_sk',DB::raw('(SELECT Nama FROM tb_datapribadi WHERE NIK = tb_sp.nik OR old_nik = tb_sp.nik) as nama'),
    ...
    public function FUNC_EDITSP($id){
      $jenisSp = DB::table('tb_mst_sp')->select('id','jenis_sp')->get();
      $editsp = SPModel::select('tb_sp.id','tb_sp.photo as photosp','tb_sp.nik','tb_datapribadi.Nama as nama','tb_sp.nik_pemberi_sp','tb_sp.jenis_sp','tb_sp.keterangan','tb_sp.tgl_sk','tb_sp.type_sp',
                      DB::raw('(select Nama from tb_datapribadi where NIK = tb_sp.nik_pemberi_sp) as nama_pemberisp'),'tb_jabatan.jabatan','tbldivmaster.nama_div_ext'
                      )
                    ->leftjoin('tb_datapribadi','tb_datapribadi.NIK','=','tb_sp.nik')
                    ->leftjoin('tb_jabatan','tb_datapribadi.idjabatan','=','tb_jabatan.id')
                    ->leftjoin('tbldivmaster','tb_datapribadi.Divisi','=','tbldivmaster.id')
    ...
    public function FUNC_GENERATESKEXCEL($id){
      ...
      $datanow = HistoryJabModel::select('tb_golongan.gol as nama_golongan','tb_jabatan.jabatan as nama_jabatan','tb_subdivisi.subdivisi as nama_subdivisi',
                                         'tb_his_jabatan.nik','tb_his_jabatan.gaji','tb_his_jabatan.tunj_jab','tb_his_jabatan.tunj_tmr',
                                         'tb_lokasikerja.lokasi','tbldivmaster.nama_div_ext as nama_divisi','tb_his_jabatan.no_sk',
      ...
      $dataprev = HistoryJabModel::select('tb_golongan.gol as nama_golongan','tb_jabatan.jabatan as nama_jabatan','tb_subdivisi.subdivisi as nama_subdivisi',
                                         'tb_his_jabatan.nik','tb_his_jabatan.gaji','tb_his_jabatan.tunj_jab','tb_his_jabatan.tunj_tmr',
                                         'tb_lokasikerja.lokasi','tbldivmaster.nama_div_ext as nama_divisi',
    ...
    public function FUNC_GENERATESKPDF_NUM($id){
      ...
      $datanow = HistoryJabModel::select('tb_his_jabatan.nik as nik', 'tb_his_jabatan.no_sk', 'tb_his_jabatan.direktur_1 as nik_dir_utama',
  ...
  {
    $listpd = PerjalananDinasModel::select('tb_perjalanandinas.id as id',
  ...
  public function FUNC_CEKADDPTH(Request $request) {
      ...
      $id = $request['id'];
      $data = PerjalananDinasModel::select('tbldivmaster.nama_div_ext as namadivisi','tb_jabatan.jabatan as namajabatan','tb_perjalanandinas.nik',
        DB::raw('DATE_FORMAT(tb_perjalanandinas.tgl_awal,"%d %M %Y") as tgl_awal'),DB::raw('DATE_FORMAT(tb_perjalanandinas.tgl_akhir,"%d %M %Y") as tgl_akhir'),'tb_perjalanandinas.jam_awal','tb_perjalanandinas.jam_akhir','tb_perjalanandinas.keterangan','tb_perjalanandinas.no_surat','tb_perjalanandinas.tgl_awal as date1','tb_perjalanandinas.tgl_akhir as date2')
  ...
  public function FUNC_DAFTARPD(){
    ...
    $nik = Session::get('nik');
    if (Session::get('admin') == 1) {
      $daftarpd = PerjalananDinasModel::select('tb_perjalanandinas.id','tb_perjalanandinas.nik','tb_perjalanandinas.jam_awal','tb_perjalanandinas.jam_akhir',
                    DB::raw('DATE_FORMAT(tb_perjalanandinas.tgl_awal,"%d %M %Y") as tgl_awal'),
                    DB::raw('DATE_FORMAT(tb_perjalanandinas.tgl_akhir,"%d %M %Y") as tgl_akhir'),
                    DB::raw('(Select Nama From tb_datapribadi where tb_datapribadi.NIK = tb_perjalanandinas.nik OR tb_datapribadi.old_nik = tb_perjalanandinas.nik) as nama_kar'),'tb_perjalanandinas.keterangan','tb_perjalanandinas.no_surat','tb_perjalanandinas.id_edit'
                    )
                  ->orderby('tb_perjalanandinas.id','DESC')
  ...
  public function FUNC_EDITPD($id){
      ...
      $editpd = PerjalananDinasModel::select('tb_perjalanandinas.id','tb_perjalanandinas.nik','tb_datapribadi.Nama as nama',
                                            'tb_perjalanandinas.tgl_awal','tb_perjalanandinas.tgl_akhir',
                                            'tb_perjalanandinas.jam_awal','tb_perjalanandinas.jam_akhir',
                                            'tb_perjalanandinas.keterangan',
                                            'tb_jabatan.jabatan','tbldivmaster.nama_div_ext',
    ...
    public function FUNC_DETAILPD(Request $request){
      ...
      $query = PerjalananDinasModel::select('tb_perjalanandinas.nik','tb_perjalanandinas.jam_awal','tb_perjalanandinas.jam_akhir','tb_perjalanandinas.keterangan',
                                    'tb_perjalanandinas.no_surat','tb_perjalanandinas.status',
